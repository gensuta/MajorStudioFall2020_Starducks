...
{
    public enum DrinkType { tea, coffee, juice, milk, smoothie }; // we don't need these but in case we do want drink types
    ...
    public static Drink CreateRandomDrink()
    {
        ...
        d.drinkType = (DrinkType)Random.Range(0, 5);
    ...
    {
        string temp = isCold ? "an iced" : "a hot";
        string s = temp + " " + flavor.ToString() + " " + drinkType.ToString();
